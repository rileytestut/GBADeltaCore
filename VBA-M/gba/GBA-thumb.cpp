...
#endif
#ifndef ADD_RD_RS_RN
static inline ATTRS(always_inline) void ADD_RD_RS_RN_func(const u32 source, const u32 dest, const u32 N)
{
...
#define ADD_RD_RS_RN(N) ADD_RD_RS_RN_func(source, dest, N);
#endif
#ifndef ADD_RD_RS_O3
static inline ATTRS(always_inline) void ADD_RD_RS_O3_func(const u32 source, const u32 dest, const u32 N)
{
    u32 lhs = reg[source].I;
    u32 rhs = N;
    u32 res = lhs + rhs;
...
#define ADD_RD_RS_O3(N) ADD_RD_RS_O3_func(source, dest, N);
#endif
#ifndef ADD_RD_RS_O3_0
# define ADD_RD_RS_O3_0 ADD_RD_RS_O3
#endif
#ifndef ADD_RN_O8
static inline ATTRS(always_inline) void ADD_RN_O8_func(const u32 opcode, const u32 d)
{
    u32 lhs = reg[(d)].I;
    u32 rhs = (opcode & 255);
    u32 res = lhs + rhs;
...
#define ADD_RN_O8(d) ADD_RN_O8_func(opcode, d);
